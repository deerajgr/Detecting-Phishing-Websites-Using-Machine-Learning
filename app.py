...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('_https://github.com/deerajgr/Detecting-Phishing-Websites-Using-Machine-Learning_')

    st.subheader('Data set')
    st.write('I used _"phishtank.org"_ & _"tranco-list.eu"_ as data sources.')
    st.write('Totally 1000000 websites ==> **_604000_ legitimate** websites | **_-396000_ phishing** websites')
